...
# "$PYTHON_BIN" "$ROOT_DIR/src/main.py" -c "$ROOT_DIR/config/mean_field_1_target_no_viz.json"
# "$PYTHON_BIN" "$ROOT_DIR/src/main.py" -c "$ROOT_DIR/config/mean_field_2_targets.json"
#"$PYTHON_BIN" "$ROOT_DIR/src/main.py" -c "$ROOT_DIR/config/mean_field_1_target_2_robots.json"
# "$PYTHON_BIN" "$ROOT_DIR/src/main.py" -c "$ROOT_DIR/config/mean_field_1_target_5_robots.json"
#"$PYTHON_BIN" "$ROOT_DIR/src/main.py" -c "$ROOT_DIR/config/mean_field_1_target_10_robots.json"
#"$PYTHON_BIN" "$ROOT_DIR/src/main.py" -c "$ROOT_DIR/config/mean_field_2_targets_2_robots.json"
# "$PYTHON_BIN" "$ROOT_DIR/src/main.py" -c "$ROOT_DIR/config/mean_field_2_targets_5_robots.json" 
"$PYTHON_BIN" "$ROOT_DIR/src/main.py" -c "$ROOT_DIR/config/mean_field_2_targets_10_robots.json"
...
#"$PYTHON_BIN" "$ROOT_DIR/src/main.py" -c "$ROOT_DIR/config/mean_field_4_targets.json"
